    ...
    return(
      <div className="div-principal-reinscripcion">
        ...
        <div className="div-text">
            <font size="7">Proceso de Reinscripcion Febrero - Junio 2020</font>
            <br></br>
            <table className="div-text" text-align="Center" border="1" border-color="#6D356C">
              <tr>
                ...
                <td width = "50%"><font size="3">
                  ...
                  <font color="#3ac1c3"><br></br>Publicación lunes 29 de enero de 2020.</font></p>
                  <p>REVISA TU NÚMERO DE REFERENCIA Y CONVECION CIE
                    Si no aparece envía un correo a <font color="#6D356C">maria.ochoa@tamazula.tecmm.edu.mx</font> para que te sea asignado</p></font></td>
              </tr>
              <tr>
                <td><font size="3">
                  <ul>
                    ...
                    <li> SI SOLICITASTE CONDONACIÓN,   ESPERA RESULTADOS  EL 29 DE ENERO DE 2020, <font color="#6D356C">YA QUE NO HABRÁ  REEMBOLSO.</font></li>
              ...
              <tr>
                ...
                <td>SI ERES ESTUDIANTE <font color="#6D356C">REGULAR</font> Y REALIZASTE  EL PAGO EN BANCO, PODRÁS SELECCIONAR MATERIAS DEL 3 AL 7 DE FEBRERO DE 2020. <br/><font size="5"><a href="http://187.174.80.184:8080/alum/login.jsp" target="_blank">Clic aquí para EDCORE</a></font></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><font size="7" color="#3ac1c3">INICIO DE SEMESTRE</font></td>
                <td><font size="4">
                  <ul>
           ...
           <font size="5">Las y los alumnos que necesiten factura fiscal deberán solicitarla el mismo día de su pago enviando  un correo de <font color="#6D356C">patricia.castellanos@tamazula.tecmm.edu.mx</font> la ficha de depósito y los datos con los que se generará la factura.</font>
        </div>
        <Footer/>
      </div>
    );
